---
title: "Basic R Programming (v3.0)"
...
+ 歡迎任何問題，課程中有問題請隨時到 [Slido](https://app.sli.do/event/x6ktiksl) 或透過輸入Event code__#764145__連上在Slide上發問。
...
#### R-4.1.0 was released since 2021 May.
...
#### 4. [Microsoft R Open](https://mran.microsoft.com/open) (The enhanced distribution of R from Microsoft Corporation)
...
[Link](https://bioc2021.bioconductor.org/schedule/)

![](./img/bioconductor2021.png)
